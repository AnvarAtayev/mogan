...
(texmacs-module (convert markdown markdown-menus)
  (:use (doc help-funcs) (convert markdown tmmarkdown)))
...
(define-public (supports-markdown?) #t)
(define-public (markdown-menu-show?)
